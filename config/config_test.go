...
func TestRunConditions(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			runConfig: map[string][]interface{}{"env": []interface{}{"qa"}},
			variables: map[string]interface{}{"env": "qa"},
			expected:  true,
		},
		{
			runConfig: map[string][]interface{}{"env": []interface{}{"qa"}},
		...
		{
			runConfig: map[string][]interface{}{"env": []interface{}{"dev", "qa"}},
			variables: map[string]interface{}{"env": "qa"},
			expected:  true,
		},
		{
			runConfig: map[string][]interface{}{"env": []interface{}{"dev", "qa"}, "region": []interface{}{"us-east-1"}},
			variables: map[string]interface{}{"env": "qa", "region": "us-west-2"},
			expected:  false,
		},
		{
			ignoreConfig: map[string][]interface{}{"env": []interface{}{"qa"}},
			variables:    map[string]interface{}{"env": "qa"},
			expected:     false,
		},
		{
		...
		{
			ignoreConfig: map[string][]interface{}{"env": []interface{}{"dev", "qa"}},
			variables:    map[string]interface{}{"env": "qa"},
			expected:     false,
		},
		{
			runConfig:    map[string][]interface{}{"env": []interface{}{"dev", "qa"}},
			ignoreConfig: map[string][]interface{}{"region": []interface{}{"us-west-2"}},
			variables:    map[string]interface{}{"env": "qa", "region": "us-west-2"},
			expected:     false,
		},
		{
			runConfig:    map[string][]interface{}{"env": []interface{}{"dev", "qa"}},
			ignoreConfig: map[string][]interface{}{"region": []interface{}{"us-west-2"}},
			variables:    map[string]interface{}{"env": "qa", "region": "us-east-1"},
			expected:     true,
		},
		{
			runConfig:    map[string][]interface{}{"env": []interface{}{"dev", "qa"}},
			ignoreConfig: map[string][]interface{}{"region": []interface{}{"us-west-2"}},
			variables:    map[string]interface{}{"env": "prod", "region": "us-east-1"},
			expected:     false,
		},
	}

	for _, testCase := range testCases {
		terragruntOptions := newOptionsVariables(testCase.variables)
		RunConditions := RunConditions{Run: testCase.runConfig, Ignore: testCase.ignoreConfig}
		assert.Equal(t, testCase.expected, RunConditions.ShouldRun(terragruntOptions))
	}
}
